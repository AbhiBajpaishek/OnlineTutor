<%@ Page Title="" Language="C#" MasterPageFile="~/tutor.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="AdminRegister.aspx.cs" Inherits="AdminRegister" %>
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <div class="contact_form wow fadeInLeft">
                        ...
                        <form action="#" class="submitphoto_form" method="post">
                            ...
                            <asp:RequiredFieldValidator ID="rqdfname" runat="server" ControlToValidate="txtfirstname" ValidationGroup="save" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                  <asp:RegularExpressionValidator ID="rgvfname" runat="server" ControlToValidate="txtfirstName" ValidationGroup="save" ValidationExpression="[a-zA-Z0-9\s]*$" ErrorMessage="Only Character Allowed" ForeColor="Red"></asp:RegularExpressionValidator>                  
                            ...
                            <asp:RequiredFieldValidator ID="rqdlname" runat="server" ControlToValidate="txtlastname" ValidationGroup="save" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                  <asp:RegularExpressionValidator ID="rgvlname" runat="server" ControlToValidate="txtlastName" ValidationGroup="save" ValidationExpression="[a-zA-Z0-9\s]*$" ErrorMessage="Only Character Allowed" ForeColor="Red"></asp:RegularExpressionValidator>                  
                 ...
                 <asp:RegularExpressionValidator ID="rgvmail" runat="server" ControlToValidate="txtmail" ValidationGroup="save" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ErrorMessage="invalid Format" ForeColor="Red"></asp:RegularExpressionValidator> 
                            ...
                            <asp:TextBox ID="txtpassword" runat="server" TextMode="Password" placeholder="Password" class="wp-form-control wpcf7-password"></asp:TextBox><br />
                            ...
                            <asp:TextBox ID="txtcpassword" runat="server" TextMode="Password" placeholder="Comfirm Password" class="wp-form-control wpcf7-password"></asp:TextBox><br />
                            ...
                            <asp:Button ID="Button1" runat="server" ValidationGroup="save" Class="btn btn-primary" Text="SUBMIT" OnClick="Button1_Click" />
